...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 1:59 AM on Wednesday, June 21, 2023.
	/// </remarks>
	public partial class DialogueDirector_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_AllEvents_AllRels_AllTraits_DialogueCPTPrior_NumOfCases()
		{
			...
			DialogueCPT_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(115);
			...
			if (this.NumOfCases>0) {
				DialogueChild_use_B_reduced = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(806));
			}
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				DialogueChild_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(806));
