...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 1:54 AM on Wednesday, June 21, 2023.
	/// </remarks>
	public partial class Model_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_AllEvents_AllRels_AllTraits_DialogueCPTPrior_NumberOfCases_vint__6 has executed. Set this to false to force re-execution of Changed_AllEvents_AllRels_AllTraits_DialogueCPTPrior_NumberOfCases_vint__6</summary>
		public bool Changed_AllEvents_AllRels_AllTraits_DialogueCPTPrior_NumberOfCases_vint__6_isDone;
		...
		public int[] AllEvents
		{
			...
			set {
				...
				this.Changed_AllEvents_AllRels_AllTraits_DialogueCPTPrior_NumberOfCases_vint__6_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of AllEvents and AllRels and AllTraits and DialogueCPTPrior and NumberOfCases and vint__6</summary>
		private void Changed_AllEvents_AllRels_AllTraits_DialogueCPTPrior_NumberOfCases_vint__6()
		{
			if (this.Changed_AllEvents_AllRels_AllTraits_DialogueCPTPrior_NumberOfCases_vint__6_isDone) {
				return ;
			}
			// Create array for 'DialogueCPT_marginal' Forwards messages.
			this.DialogueCPT_marginal_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(115);
			...
			DialogueCPT_use_B = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(115);
			for(int Events = 0; Events<115; Events++) {
				// Create array for 'DialogueCPT_use' Backwards messages.
			...
			for(int NCases = 0; NCases<this.NumberOfCases; NCases++) {
				...
				DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__B[NCases] = DiscreteFromDirichletOp.ProbsAverageConditional(this.vint__6[NCases], DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__B[NCases]);
			}
			...
			this.Changed_AllEvents_AllRels_AllTraits_DialogueCPTPrior_NumberOfCases_vint__6_isDone = true;
		}
		...
		private void Changed_AllEvents_NumberOfCases()
		{
			...
			for(int NCases = 0; NCases<this.NumberOfCases; NCases++) {
				this.AllEvents_marginal_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(115));
			}
		...
		private void Changed_NumberOfCases_vint__6()
		{
			...
			for(int NCases = 0; NCases<this.NumberOfCases; NCases++) {
				this.vint__6_marginal_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(509));
			}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_AllEvents_AllRels_AllTraits_DialogueCPTPrior_NumberOfCases_vint__6();
