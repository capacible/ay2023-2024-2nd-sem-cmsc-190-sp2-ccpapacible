...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 1:35 AM on Thursday, May 11, 2023.
	/// </remarks>
	public partial class Model_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_AllEvents_AllRels_AllTraits_DialogueCPTPrior_NumberOfCases()
		{
			...
			DialogueCPT_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(1);
			for(int Events = 0; Events<1; Events++) {
				// Create array for 'DialogueCPT' Forwards messages.
				DialogueCPT_F[Events] = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>(2);
			...
			DialogueCPT_use_B = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(1);
			for(int Events = 0; Events<1; Events++) {
				// Create array for 'DialogueCPT_use' Backwards messages.
				DialogueCPT_use_B[Events] = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>(2);
				for(int Traits = 0; Traits<2; Traits++) {
					// Create array for 'DialogueCPT_use' Backwards messages.
