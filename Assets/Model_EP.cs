...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 5:28 PM on Wednesday, May 10, 2023.
	/// </remarks>
	public partial class Model_EP : IGeneratedAlgorithm
	{
		...
		public Dirichlet[][][] DialogueCPTPrior
		{
			...
			set {
				if ((value!=null)&&(value.Length!=1)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+1)+" was expected for variable \'DialogueCPTPrior\'");
				}
		...
		private void Changed_DialogueCPTPrior_EventsPriors_NumberOfCases_RelStatusPriors_TraitsPriors_vint__7_vint__8_vin0()
		{
			...
			this.DialogueCPT_marginal_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(1);
			// Create array for replicates of 'DialogueCPT_rep_B_toDef'
			Dirichlet[][][] DialogueCPT_rep_B_toDef = new Dirichlet[3][][];
			for(int Rel = 0; Rel<3; Rel++) {
				// Create array for replicates of 'DialogueCPT_rep_B_toDef'
				DialogueCPT_rep_B_toDef[Rel] = new Dirichlet[1][];
			...
			for(int Rel = 0; Rel<3; Rel++) {
				// Create array for replicates of 'DialogueCPT_rep_F'
				DialogueCPT_rep_F[Rel] = new Dirichlet[1][][];
				// Create array for replicates of 'DialogueCPT_rep_B'
				DialogueCPT_rep_B[Rel] = new Dirichlet[1][][];
				// Create array for replicates of 'DialogueCPT_rep_F_marginal'
				DialogueCPT_rep_F_marginal[Rel] = new Dirichlet[1][];
				for(int Events = 0; Events<1; Events++) {
					// Create array for replicates of 'DialogueCPT_rep_F'
			...
			if (this.NumberOfCases>0) {
				vint__6_use_B_reduced = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(1167));
			}
			for(int NCases = 0; NCases<this.NumberOfCases; NCases++) {
				AllEvents_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(1));
				...
				this.AllEvents_marginal_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(1));
				AllEvents_use_B[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(1));
				...
				for(int Rel = 0; Rel<3; Rel++) {
					...
					vint__6_NCases__Rel_F[NCases][Rel] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(1167));
					// Create array for replicates of 'AllEvents_NCases_2_Traits_selector_uses_F'
					...
					for(int Traits = 0; Traits<2; Traits++) {
						...
						AllEvents_NCases_2_Traits_selector_uses_B[NCases][Rel][Traits][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(1));
						AllEvents_NCases_2_Traits_selector_uses_F[NCases][Rel][Traits][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(1));
						...
						AllEvents_NCases_2_Traits_selector_cases_F[NCases][Rel][Traits] = new DistributionStructArray<Bernoulli,bool>(1);
						for(int Events = 0; Events<1; Events++) {
						...
						// Create array for 'AllEvents_NCases_2_Traits_selector_cases_uses' Backwards messages.
						AllEvents_NCases_2_Traits_selector_cases_uses_B[NCases][Rel][Traits][0] = new DistributionStructArray<Bernoulli,bool>(1);
						for(int Events = 0; Events<1; Events++) {
							AllEvents_NCases_2_Traits_selector_cases_uses_B[NCases][Rel][Traits][0][Events] = Bernoulli.Uniform();
						}
						// Create array for 'AllEvents_NCases_2_Traits_selector_cases_uses' Forwards messages.
						AllEvents_NCases_2_Traits_selector_cases_uses_F[NCases][Rel][Traits][1] = new DistributionStructArray<Bernoulli,bool>(1);
						for(int Events = 0; Events<1; Events++) {
						...
						vint__6_NCases_2_Traits_F[NCases][Rel][Traits] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(1167));
						// Create array for replicates of 'vint__6_NCases_3_Events_F'
						vint__6_NCases_3_Events_F[NCases][Rel][Traits] = new Discrete[1];
						for(int Events = 0; Events<1; Events++) {
							vint__6_NCases_3_Events_F[NCases][Rel][Traits][Events] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(1167));
				...
				vint__6_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(1167));
				this.vint__6_marginal_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(1167));
		...
		private void Changed_vint__7_vint23()
		{
			...
			for(int index5 = 0; index5<this.vint23; index5++) {
				this.vint__7_marginal_F[index5] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(1));
			}
