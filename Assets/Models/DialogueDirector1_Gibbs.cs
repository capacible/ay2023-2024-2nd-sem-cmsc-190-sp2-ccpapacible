...
namespace Models
{
	...
	/// </remarks>
	public partial class DialogueDirector1_Gibbs : IGeneratedAlgorithm
	{
		#region Fields
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior</summary>
		public bool Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior</summary>
		public bool Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior_isInitialised;
		...
		public int[] AllEvents
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior_isInitialised = false;
		...
		public int NumOfCases
		{
			...
			set {
				if (this.NumOfCases_field!=value) {
					...
					this.Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior_isDone = false;
					this.Changed_DialogueCPTPrior_numberOfIterationsDecreased_Init_AllEvents_AllRels_AllTraits_NumOfCases_isInitialised = false;
					this.Changed_AllEvents_AllRels_AllTraits_DialogueCPTPrior_numberOfIterations_NumOfCases_isDone = false;
				}
			}
		...
		private void Changed_AllEvents_AllRels_AllTraits_DialogueCPTPrior_numberOfIterations_NumOfCases(int numberOfIterations)
		{
			...
			DistributionRefArray<Discrete,int>[] DialogueChild_uses_B;
			// Create array for 'DialogueChild_uses' Backwards messages.
			DialogueChild_uses_B = new DistributionRefArray<Discrete,int>[0];
			Vector[] DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__F;
			...
			DialogueChild_B = new int[this.NumOfCases];
			DistributionRefArray<Dirichlet,Vector>[] DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__uses_B;
			// Create array for 'DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__uses' Backwards messages.
			DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__uses_B = new DistributionRefArray<Dirichlet,Vector>[1];
			// Create array for 'DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__uses' Backwards messages.
			DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__uses_B[0] = new DistributionRefArray<Dirichlet,Vector>(this.NumOfCases);
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__uses_B[0][NCases] = ArrayHelper.MakeUniform<Dirichlet>(this.DialogueCPTPrior[this.AllEvents[NCases]][this.AllTraits[NCases]][this.AllRels[NCases]]);
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__F = Collection.GetItemsFromDeepJagged<Vector>(DialogueCPT_uses_F[0], this.AllEvents, this.AllTraits, this.AllRels);
				for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				...
				// Message to 'DialogueChild_marginal' from UsesEqualDef factor
				this.DialogueChild_marginal_F = UsesEqualDefGibbsOp<int[]>.MarginalGibbs<DistributionRefArray<Discrete,int>>(DialogueChild_uses_B, DialogueChild_F, this.DialogueChild_marginal_F);
				// Message to 'DialogueChild' from UsesEqualDef factor
				DialogueChild_B = UsesEqualDefGibbsOp<int[]>.DefGibbs<DistributionRefArray<Discrete,int>>(this.DialogueChild_marginal_F, DialogueChild_B);
				for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
					// Message to 'DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__uses' from Discrete factor
					DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__uses_B[0][NCases] = DiscreteFromDirichletOp.ProbsAverageConditional(DialogueChild_B[NCases], DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__uses_B[0][NCases]);
				}
				// Message to 'DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases_' from ReplicateWithMarginal factor
				DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__B = ReplicateGibbsOp<Vector[]>.DefGibbs<DistributionRefArray<Dirichlet,Vector>>(DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__uses_B, DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__B);
				// Message to 'DialogueCPT_uses' from GetItemsFromDeepJagged factor
				this.DialogueCPT_uses_B[0] = GetItemsFromDeepJaggedOp<Vector>.ArrayAverageConditional<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,DistributionRefArray<Dirichlet,Vector>,Dirichlet>(DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_AllRels_NCases__B, this.AllEvents, this.AllTraits, this.AllRels, this.DialogueCPT_uses_B[0]);
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and NumOfCases and must reset on changes to AllEvents and AllRels and AllTraits and DialogueCPTPrior</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior_isInitialised)) {
				return ;
			}
			...
			this.Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior_isDone = true;
			this.Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior_isInitialised = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_numberOfIterationsDecreased_NumOfCases_Init_AllEvents_AllRels_AllTraits_DialogueCPTPrior(initialise);
