...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 6:18 PM on Tuesday, July 11, 2023.
	/// </remarks>
	public partial class DirectorTraining_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_AllEvents_AllRels_AllTraits_DialogueChild_DialogueCPTPrior_NumOfCases()
		{
			...
			this.DialogueCPT_marginal_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(148);
		...
		private void Changed_AllEvents_NumOfCases()
		{
			...
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				this.AllEvents_marginal_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(148));
			}
