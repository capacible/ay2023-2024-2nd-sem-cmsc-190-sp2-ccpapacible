...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 2:19 PM on Wednesday, May 22, 2024.
	/// </remarks>
	public partial class DialogueDirector5_EP : IGeneratedAlgorithm
	{
		#region Fields
		/// <summary>Field backing the AllRels property</summary>
		private int[] AllRels_field;
		/// <summary>True if Changed_AllRels_DialogueCPTPrior_EventsPriors_NumOfCases_TraitsPriors has executed. Set this to false to force re-execution of Changed_AllRels_DialogueCPTPrior_EventsPriors_NumOfCases_TraitsPriors</summary>
		public bool Changed_AllRels_DialogueCPTPrior_EventsPriors_NumOfCases_TraitsPriors_isDone;
		...
		public int[] AllRels
		{
			...
			set {
				...
				this.Changed_AllRels_DialogueCPTPrior_EventsPriors_NumOfCases_TraitsPriors_isDone = false;
			}
		}
		...
		public Dirichlet[][][] DialogueCPTPrior
		{
			...
			set {
				if ((value!=null)&&(value.Length!=214)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+214)+" was expected for variable \'DialogueCPTPrior\'");
				}
		...
		#region Methods
		/// <summary>Computations that depend on the observed value of AllRels and DialogueCPTPrior and EventsPriors and NumOfCases and TraitsPriors</summary>
		private void Changed_AllRels_DialogueCPTPrior_EventsPriors_NumOfCases_TraitsPriors()
		{
			if (this.Changed_AllRels_DialogueCPTPrior_EventsPriors_NumOfCases_TraitsPriors_isDone) {
				return ;
			}
			...
			DialogueCPT_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(214);
			for(int Events = 0; Events<214; Events++) {
				// Create array for 'DialogueCPT' Forwards messages.
			...
			this.DialogueCPT_marginal_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(214);
			...
			DialogueCPT_use_B = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(214);
			for(int Events = 0; Events<214; Events++) {
				// Create array for 'DialogueCPT_use' Backwards messages.
			...
			Discrete[][][] AllEvents_NCases__Traits_selector_uses_F = new Discrete[this.NumOfCases][][];
			...
			Discrete[] AllTraits_NCases__selector_uses_F_marginal = new Discrete[this.NumOfCases];
			// Create array for replicates of 'AllTraits_NCases__selector_uses_B_toDef'
			Discrete[] AllTraits_NCases__selector_uses_B_toDef = new Discrete[this.NumOfCases];
			// Create array for replicates of 'AllEvents_NCases__Traits_selector_uses_B'
			Discrete[][][] AllEvents_NCases__Traits_selector_uses_B = new Discrete[this.NumOfCases][][];
			// Create array for replicates of 'AllEvents_NCases__Traits_selector_cases_F'
			DistributionStructArray<Bernoulli,bool>[][] AllEvents_NCases__Traits_selector_cases_F = new DistributionStructArray<Bernoulli,bool>[this.NumOfCases][];
			// Create array for replicates of 'AllEvents_NCases__Traits_selector_cases_uses_F'
			DistributionStructArray<Bernoulli,bool>[][][] AllEvents_NCases__Traits_selector_cases_uses_F = new DistributionStructArray<Bernoulli,bool>[this.NumOfCases][][];
			// Create array for replicates of 'AllEvents_NCases__Traits_selector_cases_uses_B'
			DistributionStructArray<Bernoulli,bool>[][][] AllEvents_NCases__Traits_selector_cases_uses_B = new DistributionStructArray<Bernoulli,bool>[this.NumOfCases][][];
			...
			DistributionRefArray<Dirichlet,Vector>[][] DialogueCPT_use_F_Events__Traits__marginal = new DistributionRefArray<Dirichlet,Vector>[14][];
			// Create array for replicates of 'DialogueCPT_itemAllRels_NCases__B'
			DistributionRefArray<Dirichlet,Vector>[][] DialogueCPT_itemAllRels_NCases__B = new DistributionRefArray<Dirichlet,Vector>[14][];
			// Create array for replicates of 'DialogueCPT_itemAllRels_NCases__F'
			DistributionRefArray<Dirichlet,Vector>[][] DialogueCPT_itemAllRels_NCases__F = new DistributionRefArray<Dirichlet,Vector>[14][];
			for(int Traits = 0; Traits<14; Traits++) {
				// Create array for replicates of 'DialogueCPT_itemAllRels_NCases__F'
				DialogueCPT_itemAllRels_NCases__F[Traits] = new DistributionRefArray<Dirichlet,Vector>[214];
				// Create array for replicates of 'DialogueCPT_itemAllRels_NCases__B'
				DialogueCPT_itemAllRels_NCases__B[Traits] = new DistributionRefArray<Dirichlet,Vector>[214];
				// Create array for replicates of 'DialogueCPT_use_F_Events__Traits__marginal'
				DialogueCPT_use_F_Events__Traits__marginal[Traits] = new DistributionRefArray<Dirichlet,Vector>[214];
				for(int Events = 0; Events<214; Events++) {
					// Create array for 'DialogueCPT_itemAllRels_NCases_' Forwards messages.
					DialogueCPT_itemAllRels_NCases__F[Traits][Events] = new DistributionRefArray<Dirichlet,Vector>(this.NumOfCases);
					// Create array for 'DialogueCPT_itemAllRels_NCases_' Backwards messages.
					DialogueCPT_itemAllRels_NCases__B[Traits][Events] = new DistributionRefArray<Dirichlet,Vector>(this.NumOfCases);
					DialogueCPT_use_F_Events__Traits__marginal[Traits][Events] = GetItemsOp<Vector>.MarginalInit<DistributionRefArray<Dirichlet,Vector>>(DialogueCPT_F[Events][Traits]);
					DialogueCPT_use_F_Events__Traits__marginal[Traits][Events] = GetItemsOp<Vector>.Marginal<DistributionRefArray<Dirichlet,Vector>,Dirichlet>(this.DialogueCPTPrior[Events][Traits], DialogueCPT_use_B[Events][Traits], DialogueCPT_use_F_Events__Traits__marginal[Traits][Events]);
				}
			}
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				for(int Traits = 0; Traits<14; Traits++) {
					for(int Events = 0; Events<214; Events++) {
						DialogueCPT_itemAllRels_NCases__B[Traits][Events][NCases] = ArrayHelper.MakeUniform<Dirichlet>(this.DialogueCPTPrior[Events][Traits][this.AllRels[NCases]]);
						DialogueCPT_itemAllRels_NCases__F[Traits][Events][NCases] = ArrayHelper.MakeUniform<Dirichlet>(this.DialogueCPTPrior[Events][Traits][this.AllRels[NCases]]);
						// Message to 'DialogueCPT_itemAllRels_NCases_' from GetItems factor
						DialogueCPT_itemAllRels_NCases__F[Traits][Events][NCases] = GetItemsOp<Vector>.ItemsAverageConditional<DistributionRefArray<Dirichlet,Vector>,Dirichlet>(DialogueCPT_itemAllRels_NCases__B[Traits][Events][NCases], DialogueCPT_F[Events][Traits], DialogueCPT_use_F_Events__Traits__marginal[Traits][Events], this.AllRels, NCases, DialogueCPT_itemAllRels_NCases__F[Traits][Events][NCases]);
					}
				}
			}
			...
			if (this.NumOfCases>0) {
				DialogueChild_use_B_reduced = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(672));
			}
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				AllEvents_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(214));
				...
				DialogueChild_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(672));
				this.DialogueChild_marginal_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(672));
				...
				AllTraits_NCases__selector_uses_F[NCases][0] = ReplicateOp_Divide.UsesAverageConditional<Discrete>(AllTraits_NCases__selector_uses_B[NCases][0], AllTraits_NCases__selector_uses_F_marginal[NCases], 0, AllTraits_NCases__selector_uses_F[NCases][0]);
				...
				// Create array for replicates of 'AllEvents_NCases__Traits_selector_uses_F'
				AllEvents_NCases__Traits_selector_uses_F[NCases] = new Discrete[14][];
				// Create array for replicates of 'AllEvents_NCases__Traits_selector_uses_B'
				AllEvents_NCases__Traits_selector_uses_B[NCases] = new Discrete[14][];
				// Create array for replicates of 'AllEvents_NCases__Traits_selector_cases_F'
				AllEvents_NCases__Traits_selector_cases_F[NCases] = new DistributionStructArray<Bernoulli,bool>[14];
				// Create array for replicates of 'AllEvents_NCases__Traits_selector_cases_uses_F'
				AllEvents_NCases__Traits_selector_cases_uses_F[NCases] = new DistributionStructArray<Bernoulli,bool>[14][];
				// Create array for replicates of 'AllEvents_NCases__Traits_selector_cases_uses_B'
				AllEvents_NCases__Traits_selector_cases_uses_B[NCases] = new DistributionStructArray<Bernoulli,bool>[14][];
				// Create array for replicates of 'DialogueChild_NCases__Traits_F'
				DialogueChild_NCases__Traits_F[NCases] = new Discrete[14];
				// Create array for replicates of 'DialogueChild_NCases_2_Events_F'
				DialogueChild_NCases_2_Events_F[NCases] = new Discrete[14][];
				for(int Traits = 0; Traits<14; Traits++) {
					...
					AllEvents_NCases__Traits_selector_uses_B[NCases][Traits][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(214));
					AllEvents_NCases__Traits_selector_uses_F[NCases][Traits][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(214));
					...
					// Create array for 'AllEvents_NCases__Traits_selector_cases' Forwards messages.
					AllEvents_NCases__Traits_selector_cases_F[NCases][Traits] = new DistributionStructArray<Bernoulli,bool>(214);
					for(int Events = 0; Events<214; Events++) {
						AllEvents_NCases__Traits_selector_cases_F[NCases][Traits][Events] = Bernoulli.Uniform();
						// Message to 'AllEvents_NCases__Traits_selector_cases' from CasesInt factor
						AllEvents_NCases__Traits_selector_cases_F[NCases][Traits][Events] = IntCasesOp.CasesAverageConditional(AllEvents_NCases__Traits_selector_uses_F[NCases][Traits][0], Events);
					}
					// Create array for 'AllEvents_NCases__Traits_selector_cases_uses' Forwards messages.
					AllEvents_NCases__Traits_selector_cases_uses_F[NCases][Traits] = new DistributionStructArray<Bernoulli,bool>[2];
					// Create array for 'AllEvents_NCases__Traits_selector_cases_uses' Backwards messages.
					AllEvents_NCases__Traits_selector_cases_uses_B[NCases][Traits] = new DistributionStructArray<Bernoulli,bool>[2];
					// Create array for 'AllEvents_NCases__Traits_selector_cases_uses' Backwards messages.
					AllEvents_NCases__Traits_selector_cases_uses_B[NCases][Traits][0] = new DistributionStructArray<Bernoulli,bool>(214);
					for(int Events = 0; Events<214; Events++) {
						AllEvents_NCases__Traits_selector_cases_uses_B[NCases][Traits][0][Events] = Bernoulli.Uniform();
					}
					// Create array for 'AllEvents_NCases__Traits_selector_cases_uses' Forwards messages.
					AllEvents_NCases__Traits_selector_cases_uses_F[NCases][Traits][1] = new DistributionStructArray<Bernoulli,bool>(214);
					for(int Events = 0; Events<214; Events++) {
						AllEvents_NCases__Traits_selector_cases_uses_F[NCases][Traits][1][Events] = Bernoulli.Uniform();
					}
					// Message to 'AllEvents_NCases__Traits_selector_cases_uses' from Replicate factor
					AllEvents_NCases__Traits_selector_cases_uses_F[NCases][Traits][1] = ReplicateOp_NoDivide.UsesAverageConditional<DistributionStructArray<Bernoulli,bool>>(AllEvents_NCases__Traits_selector_cases_uses_B[NCases][Traits], AllEvents_NCases__Traits_selector_cases_F[NCases][Traits], 1, AllEvents_NCases__Traits_selector_cases_uses_F[NCases][Traits][1]);
					DialogueChild_NCases__Traits_F[NCases][Traits] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(672));
					// Create array for replicates of 'DialogueChild_NCases_2_Events_F'
					DialogueChild_NCases_2_Events_F[NCases][Traits] = new Discrete[214];
					for(int Events = 0; Events<214; Events++) {
						DialogueChild_NCases_2_Events_F[NCases][Traits][Events] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(672));
						// Message to 'DialogueChild_NCases_2_Events' from Discrete factor
						DialogueChild_NCases_2_Events_F[NCases][Traits][Events] = DiscreteFromDirichletOp.SampleAverageConditional(DialogueCPT_itemAllRels_NCases__F[Traits][Events][NCases], DialogueChild_NCases_2_Events_F[NCases][Traits][Events]);
					}
					// Message to 'DialogueChild_NCases__Traits' from Exit factor
					DialogueChild_NCases__Traits_F[NCases][Traits] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(AllEvents_NCases__Traits_selector_cases_uses_F[NCases][Traits][1], DialogueChild_NCases_2_Events_F[NCases][Traits], DialogueChild_NCases__Traits_F[NCases][Traits]);
				}
			...
			this.Changed_AllRels_DialogueCPTPrior_EventsPriors_NumOfCases_TraitsPriors_isDone = true;
		}
		...
		{
			this.Changed_AllRels_DialogueCPTPrior_EventsPriors_NumOfCases_TraitsPriors();
