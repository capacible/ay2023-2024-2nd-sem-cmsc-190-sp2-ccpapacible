...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 8:51 AM on Wednesday, December 6, 2023.
	/// </remarks>
	public partial class DialogueDirector5_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_AllRels_DialogueCPTPrior_EventsPriors_NumOfCases_TraitsPriors()
		{
			...
			for(int Traits = 0; Traits<14; Traits++) {
				// Create array for replicates of 'DialogueCPT_itemAllRels_NCases__F'
				DialogueCPT_itemAllRels_NCases__F[Traits] = new DistributionRefArray<Dirichlet,Vector>[215];
				// Create array for replicates of 'DialogueCPT_itemAllRels_NCases__B'
				DialogueCPT_itemAllRels_NCases__B[Traits] = new DistributionRefArray<Dirichlet,Vector>[215];
				// Create array for replicates of 'DialogueCPT_use_F_Events__Traits__marginal'
				DialogueCPT_use_F_Events__Traits__marginal[Traits] = new DistributionRefArray<Dirichlet,Vector>[215];
				for(int Events = 0; Events<215; Events++) {
			...
			if (this.NumOfCases>0) {
				DialogueChild_use_B_reduced = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(676));
			}
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				...
				DialogueChild_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(676));
				this.DialogueChild_marginal_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(676));
				...
				for(int Traits = 0; Traits<14; Traits++) {
					...
					AllEvents_NCases__Traits_selector_uses_B[NCases][Traits][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(215));
					AllEvents_NCases__Traits_selector_uses_F[NCases][Traits][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(215));
					...
					AllEvents_NCases__Traits_selector_cases_F[NCases][Traits] = new DistributionStructArray<Bernoulli,bool>(215);
					for(int Events = 0; Events<215; Events++) {
					...
					// Create array for 'AllEvents_NCases__Traits_selector_cases_uses' Backwards messages.
					AllEvents_NCases__Traits_selector_cases_uses_B[NCases][Traits][0] = new DistributionStructArray<Bernoulli,bool>(215);
					for(int Events = 0; Events<215; Events++) {
						AllEvents_NCases__Traits_selector_cases_uses_B[NCases][Traits][0][Events] = Bernoulli.Uniform();
					}
					// Create array for 'AllEvents_NCases__Traits_selector_cases_uses' Forwards messages.
					AllEvents_NCases__Traits_selector_cases_uses_F[NCases][Traits][1] = new DistributionStructArray<Bernoulli,bool>(215);
					for(int Events = 0; Events<215; Events++) {
					...
					DialogueChild_NCases__Traits_F[NCases][Traits] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(676));
					// Create array for replicates of 'DialogueChild_NCases_2_Events_F'
					DialogueChild_NCases_2_Events_F[NCases][Traits] = new Discrete[215];
					for(int Events = 0; Events<215; Events++) {
						DialogueChild_NCases_2_Events_F[NCases][Traits][Events] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(676));
