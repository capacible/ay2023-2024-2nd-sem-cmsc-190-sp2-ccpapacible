...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 8:48 AM on Thursday, May 16, 2024.
	/// </remarks>
		...
		private void Changed_AllRels_DialogueCPTPrior_EventsPriors_NumOfCases_TraitsPriors()
		{
			...
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				...
				for(int Traits = 0; Traits<14; Traits++) {
					...
					for(int Events = 0; Events<214; Events++) {
						DialogueChild_NCases_2_Events_F[NCases][Traits][Events] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(678));
