...
namespace Models
{
	...
	public partial class DialogueDirector0_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_AllEvents_AllTraits_DialogueCPTPrior_NumOfCases_RelStatusPriors has executed. Set this to false to force re-execution of Changed_AllEvents_AllTraits_DialogueCPTPrior_NumOfCases_RelStatusPriors</summary>
		public bool Changed_AllEvents_AllTraits_DialogueCPTPrior_NumOfCases_RelStatusPriors_isDone;
		...
		public int[] AllEvents
		{
			...
			set {
				...
				this.Changed_AllEvents_AllTraits_DialogueCPTPrior_NumOfCases_RelStatusPriors_isDone = false;
			}
		}
		...
		#region Methods
		/// <summary>Computations that depend on the observed value of AllEvents and AllTraits and DialogueCPTPrior and NumOfCases and RelStatusPriors</summary>
		private void Changed_AllEvents_AllTraits_DialogueCPTPrior_NumOfCases_RelStatusPriors()
		{
			if (this.Changed_AllEvents_AllTraits_DialogueCPTPrior_NumOfCases_RelStatusPriors_isDone) {
				return ;
			}
			...
			DialogueCPT_use_F_marginal = GetItemsFromJaggedOp<Vector[]>.MarginalInit<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>>(DialogueCPT_F);
			for(int Rel = 0; Rel<3; Rel++) {
				for(int Events = 0; Events<214; Events++) {
					for(int Traits = 0; Traits<14; Traits++) {
			...
			DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]> DialogueCPT_itemAllEvents_NCases_AllTraits_NCases__B;
			// Create array for 'DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_' Backwards messages.
			DialogueCPT_itemAllEvents_NCases_AllTraits_NCases__B = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>(this.NumOfCases);
			DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]> DialogueCPT_itemAllEvents_NCases_AllTraits_NCases__F;
			// Create array for 'DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_' Forwards messages.
			DialogueCPT_itemAllEvents_NCases_AllTraits_NCases__F = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>(this.NumOfCases);
			...
			DialogueCPT_use_F_marginal = GetItemsFromJaggedOp<Vector[]>.Marginal<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>>(DialogueCPT_F, DialogueCPT_use_B, DialogueCPT_use_F_marginal);
			...
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				...
				// Create array for 'DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_' Forwards messages.
				DialogueCPT_itemAllEvents_NCases_AllTraits_NCases__F[NCases] = new DistributionRefArray<Dirichlet,Vector>(3);
				// Create array for 'DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_' Backwards messages.
				DialogueCPT_itemAllEvents_NCases_AllTraits_NCases__B[NCases] = new DistributionRefArray<Dirichlet,Vector>(3);
				for(int Rel = 0; Rel<3; Rel++) {
					DialogueCPT_itemAllEvents_NCases_AllTraits_NCases__B[NCases][Rel] = ArrayHelper.MakeUniform<Dirichlet>(this.DialogueCPTPrior[this.AllEvents[NCases]][this.AllTraits[NCases]][Rel]);
					DialogueCPT_itemAllEvents_NCases_AllTraits_NCases__F[NCases][Rel] = ArrayHelper.MakeUniform<Dirichlet>(this.DialogueCPTPrior[this.AllEvents[NCases]][this.AllTraits[NCases]][Rel]);
				}
				// Message to 'DialogueCPT_itemAllEvents_NCases_AllTraits_NCases_' from GetItemsFromJagged factor
				DialogueCPT_itemAllEvents_NCases_AllTraits_NCases__F[NCases] = GetItemsFromJaggedOp<Vector[]>.ItemsAverageConditional<DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>,DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,DistributionRefArray<Dirichlet,Vector>>(DialogueCPT_itemAllEvents_NCases_AllTraits_NCases__B[NCases], DialogueCPT_F, DialogueCPT_use_F_marginal, this.AllEvents, this.AllTraits, NCases, DialogueCPT_itemAllEvents_NCases_AllTraits_NCases__F[NCases]);
				...
				AllRels_NCases__selector_uses_F[NCases] = new Discrete[2];
				// Create array for 'AllRels_NCases__selector_uses' Backwards messages.
				AllRels_NCases__selector_uses_B[NCases] = new Discrete[2];
				AllRels_NCases__selector_uses_B[NCases][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(3));
				...
				AllRels_NCases__selector_uses_F[NCases][0] = ReplicateOp_NoDivide.UsesAverageConditional<Discrete>(AllRels_NCases__selector_uses_B[NCases], AllRels_F[NCases], 0, AllRels_NCases__selector_uses_F[NCases][0]);
				...
				for(int Rel = 0; Rel<3; Rel++) {
					DialogueChild_NCases__Rel_F[NCases][Rel] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(672));
					// Message to 'DialogueChild_NCases__Rel' from Discrete factor
					DialogueChild_NCases__Rel_F[NCases][Rel] = DiscreteFromDirichletOp.SampleAverageConditional(DialogueCPT_itemAllEvents_NCases_AllTraits_NCases__F[NCases][Rel], DialogueChild_NCases__Rel_F[NCases][Rel]);
				}
			...
			this.Changed_AllEvents_AllTraits_DialogueCPTPrior_NumOfCases_RelStatusPriors_isDone = true;
		}
		...
		{
			this.Changed_AllEvents_AllTraits_DialogueCPTPrior_NumOfCases_RelStatusPriors();
