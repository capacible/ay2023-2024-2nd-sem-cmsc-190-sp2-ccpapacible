...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 10:04 PM on Wednesday, July 19, 2023.
	/// </remarks>
	public partial class DialogueDirector0_EP : IGeneratedAlgorithm
	{
		...
		public Dirichlet[][][] DialogueCPTPrior
		{
			...
			set {
				if ((value!=null)&&(value.Length!=159)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+159)+" was expected for variable \'DialogueCPTPrior\'");
				}
		...
		private void Changed_AllRels_AllTraits_DialogueCPTPrior_EventsPriors_NumOfCases()
		{
			...
			DialogueCPT_F = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(159);
			...
			DialogueCPT_use_B = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(159);
			// Create array for replicates of 'DialogueCPT_itemAllTraits_NCases_AllRels_NCases__B'
			DistributionRefArray<Dirichlet,Vector>[] DialogueCPT_itemAllTraits_NCases_AllRels_NCases__B = new DistributionRefArray<Dirichlet,Vector>[159];
			// Create array for replicates of 'DialogueCPT_itemAllTraits_NCases_AllRels_NCases__F'
			DistributionRefArray<Dirichlet,Vector>[] DialogueCPT_itemAllTraits_NCases_AllRels_NCases__F = new DistributionRefArray<Dirichlet,Vector>[159];
			// Create array for replicates of 'DialogueCPT_use_F_Events__marginal'
			DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>[] DialogueCPT_use_F_Events__marginal = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>[159];
			for(int Events = 0; Events<159; Events++) {
				// Create array for 'DialogueCPT' Forwards messages.
			...
			if (this.NumOfCases>0) {
				DialogueChild_use_B_reduced = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(632));
			}
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				AllEvents_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(159));
				...
				DialogueChild_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(632));
				this.DialogueChild_marginal_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(632));
				...
				AllEvents_NCases__selector_uses_B[NCases][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(159));
				AllEvents_NCases__selector_uses_F[NCases][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(159));
				...
				AllEvents_NCases__selector_cases_F[NCases] = new DistributionStructArray<Bernoulli,bool>(159);
				for(int Events = 0; Events<159; Events++) {
				...
				// Create array for 'AllEvents_NCases__selector_cases_uses' Backwards messages.
				AllEvents_NCases__selector_cases_uses_B[NCases][0] = new DistributionStructArray<Bernoulli,bool>(159);
				for(int Events = 0; Events<159; Events++) {
					AllEvents_NCases__selector_cases_uses_B[NCases][0][Events] = Bernoulli.Uniform();
				}
				// Create array for 'AllEvents_NCases__selector_cases_uses' Forwards messages.
				AllEvents_NCases__selector_cases_uses_F[NCases][1] = new DistributionStructArray<Bernoulli,bool>(159);
				for(int Events = 0; Events<159; Events++) {
				...
				// Create array for replicates of 'DialogueChild_NCases__Events_F'
				DialogueChild_NCases__Events_F[NCases] = new Discrete[159];
				for(int Events = 0; Events<159; Events++) {
					DialogueChild_NCases__Events_F[NCases][Events] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(632));
