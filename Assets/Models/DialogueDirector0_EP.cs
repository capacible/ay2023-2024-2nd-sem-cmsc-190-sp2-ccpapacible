...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 5:37 PM on Wednesday, July 12, 2023.
	/// </remarks>
	public partial class DialogueDirector0_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_AllRels_AllTraits_DialogueCPTPrior_EventsPriors_NumOfCases()
		{
			...
			DistributionRefArray<Dirichlet,Vector>[] DialogueCPT_itemAllTraits_NCases_AllRels_NCases__B = new DistributionRefArray<Dirichlet,Vector>[148];
			// Create array for replicates of 'DialogueCPT_itemAllTraits_NCases_AllRels_NCases__F'
			DistributionRefArray<Dirichlet,Vector>[] DialogueCPT_itemAllTraits_NCases_AllRels_NCases__F = new DistributionRefArray<Dirichlet,Vector>[148];
			// Create array for replicates of 'DialogueCPT_use_F_Events__marginal'
			DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>[] DialogueCPT_use_F_Events__marginal = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>[148];
			...
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				AllEvents_F[NCases] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(148));
				...
				AllEvents_NCases__selector_uses_B[NCases][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(148));
				AllEvents_NCases__selector_uses_F[NCases][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(148));
				...
				AllEvents_NCases__selector_cases_F[NCases] = new DistributionStructArray<Bernoulli,bool>(148);
				for(int Events = 0; Events<148; Events++) {
				...
				// Create array for 'AllEvents_NCases__selector_cases_uses' Backwards messages.
				AllEvents_NCases__selector_cases_uses_B[NCases][0] = new DistributionStructArray<Bernoulli,bool>(148);
				for(int Events = 0; Events<148; Events++) {
					AllEvents_NCases__selector_cases_uses_B[NCases][0][Events] = Bernoulli.Uniform();
				}
				// Create array for 'AllEvents_NCases__selector_cases_uses' Forwards messages.
				AllEvents_NCases__selector_cases_uses_F[NCases][1] = new DistributionStructArray<Bernoulli,bool>(148);
				for(int Events = 0; Events<148; Events++) {
				...
				// Create array for replicates of 'DialogueChild_NCases__Events_F'
				DialogueChild_NCases__Events_F[NCases] = new Discrete[148];
				for(int Events = 0; Events<148; Events++) {
					DialogueChild_NCases__Events_F[NCases][Events] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(606));
