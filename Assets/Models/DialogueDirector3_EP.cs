...
namespace Models
{
	...
	public partial class DialogueDirector3_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_AllEvents_DialogueCPTPrior_NumOfCases_RelStatusPriors_TraitsPriors has executed. Set this to false to force re-execution of Changed_AllEvents_DialogueCPTPrior_NumOfCases_RelStatusPriors_TraitsPriors</summary>
		public bool Changed_AllEvents_DialogueCPTPrior_NumOfCases_RelStatusPriors_TraitsPriors_isDone;
		...
		public int[] AllEvents
		{
			...
			set {
				...
				this.Changed_AllEvents_DialogueCPTPrior_NumOfCases_RelStatusPriors_TraitsPriors_isDone = false;
			}
		}
		...
		#region Methods
		/// <summary>Computations that depend on the observed value of AllEvents and DialogueCPTPrior and NumOfCases and RelStatusPriors and TraitsPriors</summary>
		private void Changed_AllEvents_DialogueCPTPrior_NumOfCases_RelStatusPriors_TraitsPriors()
		{
			if (this.Changed_AllEvents_DialogueCPTPrior_NumOfCases_RelStatusPriors_TraitsPriors_isDone) {
				return ;
			}
			...
			// Create array for replicates of 'DialogueChild_NCases_2_Traits_F'
			Discrete[][][] DialogueChild_NCases_2_Traits_F = new Discrete[this.NumOfCases][][];
			...
			Discrete[][][] AllTraits_NCases__Rel_selector_uses_F = new Discrete[this.NumOfCases][][];
			...
			Discrete[][][] AllTraits_NCases__Rel_selector_uses_B = new Discrete[this.NumOfCases][][];
			// Create array for replicates of 'AllTraits_NCases__Rel_selector_cases_F'
			DistributionStructArray<Bernoulli,bool>[][] AllTraits_NCases__Rel_selector_cases_F = new DistributionStructArray<Bernoulli,bool>[this.NumOfCases][];
			// Create array for replicates of 'AllTraits_NCases__Rel_selector_cases_uses_F'
			DistributionStructArray<Bernoulli,bool>[][][] AllTraits_NCases__Rel_selector_cases_uses_F = new DistributionStructArray<Bernoulli,bool>[this.NumOfCases][][];
			// Create array for replicates of 'AllTraits_NCases__Rel_selector_cases_uses_B'
			DistributionStructArray<Bernoulli,bool>[][][] AllTraits_NCases__Rel_selector_cases_uses_B = new DistributionStructArray<Bernoulli,bool>[this.NumOfCases][][];
			...
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				...
				// Create array for replicates of 'DialogueChild_NCases_2_Traits_F'
				DialogueChild_NCases_2_Traits_F[NCases] = new Discrete[3][];
				for(int Rel = 0; Rel<3; Rel++) {
					...
					AllTraits_NCases__Rel_selector_uses_B[NCases][Rel][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(14));
					AllTraits_NCases__Rel_selector_uses_F[NCases][Rel][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(14));
					...
					AllTraits_NCases__Rel_selector_cases_F[NCases][Rel] = new DistributionStructArray<Bernoulli,bool>(14);
					for(int Traits = 0; Traits<14; Traits++) {
					...
					// Create array for 'AllTraits_NCases__Rel_selector_cases_uses' Backwards messages.
					AllTraits_NCases__Rel_selector_cases_uses_B[NCases][Rel][0] = new DistributionStructArray<Bernoulli,bool>(14);
					for(int Traits = 0; Traits<14; Traits++) {
						AllTraits_NCases__Rel_selector_cases_uses_B[NCases][Rel][0][Traits] = Bernoulli.Uniform();
					}
					// Create array for 'AllTraits_NCases__Rel_selector_cases_uses' Forwards messages.
					AllTraits_NCases__Rel_selector_cases_uses_F[NCases][Rel][1] = new DistributionStructArray<Bernoulli,bool>(14);
					for(int Traits = 0; Traits<14; Traits++) {
					...
					// Create array for replicates of 'DialogueChild_NCases_2_Traits_F'
					DialogueChild_NCases_2_Traits_F[NCases][Rel] = new Discrete[14];
					for(int Traits = 0; Traits<14; Traits++) {
						DialogueChild_NCases_2_Traits_F[NCases][Rel][Traits] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(672));
						// Message to 'DialogueChild_NCases_2_Traits' from Discrete factor
						DialogueChild_NCases_2_Traits_F[NCases][Rel][Traits] = DiscreteFromDirichletOp.SampleAverageConditional(DialogueCPT_itemAllEvents_NCases__F[NCases][Traits][Rel], DialogueChild_NCases_2_Traits_F[NCases][Rel][Traits]);
					}
					// Message to 'DialogueChild_NCases__Rel' from Exit factor
					DialogueChild_NCases__Rel_F[NCases][Rel] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(AllTraits_NCases__Rel_selector_cases_uses_F[NCases][Rel][1], DialogueChild_NCases_2_Traits_F[NCases][Rel], DialogueChild_NCases__Rel_F[NCases][Rel]);
				}
			...
			this.Changed_AllEvents_DialogueCPTPrior_NumOfCases_RelStatusPriors_TraitsPriors_isDone = true;
		}
		...
		{
			this.Changed_AllEvents_DialogueCPTPrior_NumOfCases_RelStatusPriors_TraitsPriors();
