...
namespace Models
{
	...
	public partial class DialogueDirector4_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_AllTraits_DialogueCPTPrior_EventsPriors_NumOfCases_RelStatusPriors()
		{
			...
			DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>[] DialogueCPT_itemAllTraits_NCases__F = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>[214];
			// Create array for replicates of 'DialogueCPT_itemAllTraits_NCases__B'
			DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>[] DialogueCPT_itemAllTraits_NCases__B = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>[214];
			// Create array for replicates of 'DialogueCPT_use_F_Events__marginal'
			DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>[] DialogueCPT_use_F_Events__marginal = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>[214];
			...
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				...
				for(int Rel = 0; Rel<3; Rel++) {
					...
					AllEvents_NCases__Rel_selector_uses_B[NCases][Rel][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(214));
					AllEvents_NCases__Rel_selector_uses_F[NCases][Rel][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(214));
					...
					AllEvents_NCases__Rel_selector_cases_F[NCases][Rel] = new DistributionStructArray<Bernoulli,bool>(214);
					for(int Events = 0; Events<214; Events++) {
					...
					// Create array for 'AllEvents_NCases__Rel_selector_cases_uses' Backwards messages.
					AllEvents_NCases__Rel_selector_cases_uses_B[NCases][Rel][0] = new DistributionStructArray<Bernoulli,bool>(214);
					for(int Events = 0; Events<214; Events++) {
						AllEvents_NCases__Rel_selector_cases_uses_B[NCases][Rel][0][Events] = Bernoulli.Uniform();
					}
					// Create array for 'AllEvents_NCases__Rel_selector_cases_uses' Forwards messages.
					AllEvents_NCases__Rel_selector_cases_uses_F[NCases][Rel][1] = new DistributionStructArray<Bernoulli,bool>(214);
					for(int Events = 0; Events<214; Events++) {
					...
					// Create array for replicates of 'DialogueChild_NCases_2_Events_F'
					DialogueChild_NCases_2_Events_F[NCases][Rel] = new Discrete[214];
					for(int Events = 0; Events<214; Events++) {
						DialogueChild_NCases_2_Events_F[NCases][Rel][Events] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(672));
