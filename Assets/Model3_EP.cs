...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 7:08 PM on Wednesday, May 17, 2023.
	/// </remarks>
	public partial class Model3_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_AllEvents_AllRels_DialogueCPTPrior_NumberOfCases_TraitsPriors has executed. Set this to false to force re-execution of Changed_AllEvents_AllRels_DialogueCPTPrior_NumberOfCases_TraitsPriors</summary>
		public bool Changed_AllEvents_AllRels_DialogueCPTPrior_NumberOfCases_TraitsPriors_isDone;
		...
		public int[] AllEvents
		{
			...
			set {
				...
				this.Changed_AllEvents_AllRels_DialogueCPTPrior_NumberOfCases_TraitsPriors_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of AllEvents and AllRels and DialogueCPTPrior and NumberOfCases and TraitsPriors</summary>
		private void Changed_AllEvents_AllRels_DialogueCPTPrior_NumberOfCases_TraitsPriors()
		{
			if (this.Changed_AllEvents_AllRels_DialogueCPTPrior_NumberOfCases_TraitsPriors_isDone) {
				return ;
			}
			...
			DialogueCPT_use_B = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(40);
			for(int Events = 0; Events<40; Events++) {
				// Create array for 'DialogueCPT_use' Backwards messages.
				DialogueCPT_use_B[Events] = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>(13);
			}
			for(int Traits = 0; Traits<13; Traits++) {
				for(int Events = 0; Events<40; Events++) {
					// Create array for 'DialogueCPT_use' Backwards messages.
			...
			// Create array for replicates of 'vint__6_NCases__Traits_F'
			Discrete[][] vint__6_NCases__Traits_F = new Discrete[this.NumberOfCases][];
			// Create array for replicates of 'AllTraits_NCases__selector_cases_uses_B'
			DistributionStructArray<Bernoulli,bool>[][] AllTraits_NCases__selector_cases_uses_B = new DistributionStructArray<Bernoulli,bool>[this.NumberOfCases][];
			// Create array for replicates of 'AllTraits_NCases__selector_cases_uses_F'
			DistributionStructArray<Bernoulli,bool>[][] AllTraits_NCases__selector_cases_uses_F = new DistributionStructArray<Bernoulli,bool>[this.NumberOfCases][];
			...
			DistributionStructArray<Bernoulli,bool>[] AllTraits_NCases__selector_cases_F = new DistributionStructArray<Bernoulli,bool>[this.NumberOfCases];
			...
			DialogueCPT_itemAllEvents_NCases__B = new DistributionRefArray<DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>,Vector[][]>(this.NumberOfCases);
			...
			for(int NCases = 0; NCases<this.NumberOfCases; NCases++) {
				...
				// Create array for 'DialogueCPT_itemAllEvents_NCases_' Backwards messages.
				DialogueCPT_itemAllEvents_NCases__B[NCases] = new DistributionRefArray<DistributionRefArray<Dirichlet,Vector>,Vector[]>(13);
				for(int Traits = 0; Traits<13; Traits++) {
					// Create array for 'DialogueCPT_itemAllEvents_NCases_' Forwards messages.
				...
				AllTraits_NCases__selector_uses_F[NCases][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(13));
				...
				AllTraits_NCases__selector_cases_F[NCases] = new DistributionStructArray<Bernoulli,bool>(13);
				for(int Traits = 0; Traits<13; Traits++) {
				...
				// Create array for 'AllTraits_NCases__selector_cases_uses' Backwards messages.
				AllTraits_NCases__selector_cases_uses_B[NCases][0] = new DistributionStructArray<Bernoulli,bool>(13);
				for(int Traits = 0; Traits<13; Traits++) {
					AllTraits_NCases__selector_cases_uses_B[NCases][0][Traits] = Bernoulli.Uniform();
				}
				// Create array for 'AllTraits_NCases__selector_cases_uses' Forwards messages.
				AllTraits_NCases__selector_cases_uses_F[NCases][1] = new DistributionStructArray<Bernoulli,bool>(13);
				for(int Traits = 0; Traits<13; Traits++) {
				...
				// Create array for replicates of 'vint__6_NCases__Traits_F'
				vint__6_NCases__Traits_F[NCases] = new Discrete[13];
				for(int Traits = 0; Traits<13; Traits++) {
					vint__6_NCases__Traits_F[NCases][Traits] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(646));
					// Message to 'vint__6_NCases__Traits' from Discrete factor
					vint__6_NCases__Traits_F[NCases][Traits] = DiscreteFromDirichletOp.SampleAverageConditional(DialogueCPT_itemAllEvents_NCases__F[NCases][Traits][this.AllRels[NCases]], vint__6_NCases__Traits_F[NCases][Traits]);
				}
				// Message to 'vint__6' from Exit factor
				vint__6_F[NCases] = BeliefPropagationGateExitOp.ExitAverageConditional<Discrete>(AllTraits_NCases__selector_cases_uses_F[NCases][1], vint__6_NCases__Traits_F[NCases], vint__6_F[NCases]);
			...
			this.Changed_AllEvents_AllRels_DialogueCPTPrior_NumberOfCases_TraitsPriors_isDone = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_AllEvents_AllRels_DialogueCPTPrior_NumberOfCases_TraitsPriors();
