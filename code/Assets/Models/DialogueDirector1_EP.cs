...
namespace Models
{
	...
	public partial class DialogueDirector1_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_AllRels_AllTraits_DialogueCPTPrior_EventsPriors_NumOfCases()
		{
			...
			DistributionRefArray<Dirichlet,Vector>[] DialogueCPT_itemAllTraits_NCases_AllRels_NCases__F = new DistributionRefArray<Dirichlet,Vector>[214];
			// Create array for replicates of 'DialogueCPT_itemAllTraits_NCases_AllRels_NCases__B'
			DistributionRefArray<Dirichlet,Vector>[] DialogueCPT_itemAllTraits_NCases_AllRels_NCases__B = new DistributionRefArray<Dirichlet,Vector>[214];
			...
			for(int NCases = 0; NCases<this.NumOfCases; NCases++) {
				...
				AllEvents_NCases__selector_uses_B[NCases][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(214));
				AllEvents_NCases__selector_uses_F[NCases][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(214));
				...
				AllEvents_NCases__selector_cases_F[NCases] = new DistributionStructArray<Bernoulli,bool>(214);
				for(int Events = 0; Events<214; Events++) {
				...
				// Create array for 'AllEvents_NCases__selector_cases_uses' Backwards messages.
				AllEvents_NCases__selector_cases_uses_B[NCases][0] = new DistributionStructArray<Bernoulli,bool>(214);
				for(int Events = 0; Events<214; Events++) {
					AllEvents_NCases__selector_cases_uses_B[NCases][0][Events] = Bernoulli.Uniform();
				}
				// Create array for 'AllEvents_NCases__selector_cases_uses' Forwards messages.
				AllEvents_NCases__selector_cases_uses_F[NCases][1] = new DistributionStructArray<Bernoulli,bool>(214);
				for(int Events = 0; Events<214; Events++) {
				...
				// Create array for replicates of 'DialogueChild_NCases__Events_F'
				DialogueChild_NCases__Events_F[NCases] = new Discrete[214];
				for(int Events = 0; Events<214; Events++) {
					DialogueChild_NCases__Events_F[NCases][Events] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(672));
